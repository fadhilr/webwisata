              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Wisata</label>
                   <input type="text" class="form-control" id="nama" value="<?php echo $namaWisata ?>" name="nama" placeholder="Masukkan nama" disabled> 
                </div>
                <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  value="<?php echo $tanggal ?>" id="datepicker" name="tanggalPosting" placeholder="Masukkan tanggal" disabled>
                </div>
        </div>
        <div class="form-group">
                  <label >Preview</label>
                  <textarea type="text" class="form-control" id="preview" value="<?php echo $preview ?>" name="preview" placeholder="Preview" disabled><?php echo $preview ?></textarea>
                </div>
                <div class="form-group">
