    ...
    <div class="col-md-3">
        ...
        <label>Tanggal Posting:</label>
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  value="" id="datepicker" name="tanggalPosting">
                </div>
        </div>
        <div class="form-group">
                  <label >Preview</label>
                  <textarea type="text" class="form-control" id="preview" value="" name="preview" placeholder="Preview" > </textarea>
                </div>
                <div class="form-group">
                  <label >Lokasi di Map :</label><br>
                  <label >Latitude</label>
                  <input type="text" class="form-control pull-right"  value="" id="latitude" name="latitude" placeholder="Ex : -7.937739">

                </div>
                <div class="form-group">
                  
                  <label >Longitude</label>
                  <input type="text" class="form-control pull-right"  value="" id="longitude" name="longitude" placeholder="Ex : 112.635406">
