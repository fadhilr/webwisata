  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <!-- /.box -->
          <form action="<?php echo base_url(); ?>c_admin/tambahGaleri" method="post" enctype="multipart/form-data">
          <div class="box">
              ...
              <div class="box-body">
               ...
               <?php foreach($wisata as $f){
                ...
                <div class="form-group">
                  ...
                  <input type="file" id="exampleInputFile" name="berkas1">
                ...
                <div class="form-group">
                  ...
                  <p class="help-block"><?php if($error!=""){echo $error;}?></p>  
                  <input type="file" id="exampleInputFile" name="berkas2">
                ...
                <div class="form-group">
                  ...
                  <p class="help-block"><?php if($error!=""){echo $error;}?></p>  
                  <input type="file" id="exampleInputFile" name="berkas3">
                ...
                <div class="form-group">
                  ...
                  <p class="help-block"><?php if($error!=""){echo $error;}?></p>  
                  <input type="file" id="exampleInputFile" name="berkas4">
