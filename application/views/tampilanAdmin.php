      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <a href="<?php echo base_url();?>c_admin/tampilanTambahWisata">
              <button type="button" class="btn  btn-success btn-lg"><i class="fa fa-plus"> </i>Tambah Wisata</button>
              </a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <?php
          ...
          foreach ($wisata as $a) {
        ?>
                <tr data-id="<?php echo "$a[idWisata]"?>">
                  <td><?php echo $i++;?></td>
                  <td>
                    <img src="<?php echo base_url();?>/assets/images/foto/<?php echo "$a[foto]"?>" class="" alt="User Image" width="150px" height="150px">
                  </td>
                  <td><?php echo "$a[namaWisata]" ?>
                  </td>
                  <td> <?php echo "$a[tanggal]" ?></td>
                  <td><div class="btn-group">
                      <a href="<?php echo base_url(); ?>c_admin/tampilanInfoWisata/<?php echo "$a[idWisata]" ?>" type="button" class="btn btn-info btn-flat"><i class="fa fa-info"></i></a>
                      <a href="<?php echo base_url(); ?>c_admin/tampilanEditWisata/<?php echo "$a[idWisata]" ?>" type="button" class="btn btn-warning btn-flat"><i class="fa fa-edit"></i></a>
            
                     <button type="button" class="btn btn-danger btn-flat hapus-member " id="hapus" data-nama = "<?php echo "$a[namaWisata]"?>" data-id="<?php echo "$a[idWisata]"?>" ><i class="fa fa-trash"></i></button>
                    </div></td>
